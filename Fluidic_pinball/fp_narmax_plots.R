...
preds_n10 = readRDS("Results/narmax_preds_n10.RData")
preds_n20 = readRDS("Results/narmax_preds_n20.RData")
preds_n30 = readRDS("Results/narmax_preds_n30.RData")
nb_time_steps = 50
coordinates = c('Cl', 'Cd')
...
for(i in 1:nb_series) {
  ...
  NRMSEs_x_timestep = data.frame(index = 1:50, NRMSEs_nn_timestep[, i], 
  ...
  NRMSEs_x_timestep_minCI = data.frame(index = 1:50, NRMSEs_nn_timestep_minCI[, i], 
  ...
  NRMSEs_x_timestep_maxCI = data.frame(index = 1:50, NRMSEs_nn_timestep_maxCI[, i], 
